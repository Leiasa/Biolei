...
if (isset($_POST['submitbtn']))
{
            ...
            $sql = "INSERT INTO projects(login_id, title, owner, description) VALUES ('$id', '$title', '$owner', '$des')";
            if (mysql_query($sql))
            {
                ?>
            ...
            <form action="" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="user-dept" name="req" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="user-dept">Payment</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="user-dept" name="payment"  required>
                        </div>
                    </div>
                    <div class="form-group">
                  ...
                  <button  name ="submitbtn" id="submitbtn" type="submit" class="w3-btn btn-info btn-lg btn-set w3-teal"> Create </button>
